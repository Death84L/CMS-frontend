  ...
  return (
    <div className="flex flex-col md:flex-row md:space-x-4 mb-4">
      <input
        ...
        className="border border-gray-300 px-3 py-2 rounded focus:outline-none focus:border-orange-500 flex-grow"
      />
      <select
        value={dataType}
      ...
      <div className="container mx-auto p-6 md:p-12 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl shadow-lg">
        ...
        <div className="mb-6">
          <input
            ...
            className="border border-gray-300 px-4 py-3 rounded focus:outline-none focus:border-orange-500 w-full shadow-sm"
          />
        </div>
